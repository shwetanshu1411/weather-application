      ...
      <div className="transition-all duration-300 bg-white/80 dark:bg-gray-900/80 p-6 rounded-lg shadow-lg max-w-md w-full backdrop-blur-sm">
        ...
        <div className="mb-4">
          <input
            ...
            className="dark:text-white border-gray-700 dark:border-gray-600 rounded-md p-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-200"
          />
          <button
